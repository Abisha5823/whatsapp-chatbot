    ...
    async def create_manual_booking(self, booking_data: Dict[str, Any]) -> Optional[Booking]:
        ...
        try:
            booking = Booking(
                ...
                whatsapp_number=booking_data.get("whatsapp_number", ""),
                service_type=booking_data.get("service_type", ""),
                reason=booking_data.get("reason", ""),
                preferred_date=booking_data.get("preferred_date", ""),
                preferred_time=booking_data.get("preferred_time", ""),
                mode=booking_data.get("mode", "offline"),
                language_preference=booking_data.get("language_preference", "English"),
            ...
            logger.info(f"✅ Booking created: {booking.customer_name} ({booking.chat_id})")
            return booking
